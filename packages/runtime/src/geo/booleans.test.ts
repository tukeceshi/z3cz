...
describe("booleanPointInPolygon", () => {
  ...
  it("should handle MultiPolygon", () => {
    ...
    const ours = booleanPointInPolygon(pt, multiPoly as Parameters<typeof booleanPointInPolygon>[1]);
  ...
  it("should respect ignoreBoundary option", () => {
    ...
    const theirs = turf.booleanPointInPolygon(pt, poly, { ignoreBoundary: true });
...
describe("booleanPointOnLine", () => {
  ...
  it("should respect ignoreEndVertices option", () => {
    ...
    const theirs = turf.booleanPointOnLine(pt, line, { ignoreEndVertices: true });

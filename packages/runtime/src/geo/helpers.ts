...
export function getCoord(coord: Feature<Point> | Point | number[]): number[] {
  ...
  if (coord.type === "Feature") return (coord as Feature<Point>).geometry.coordinates;
...
export function getCoords(
  ...
  if (obj.type === "Feature") return (obj as Feature<Geometry>).geometry.coordinates;
  return (obj as Geometry).coordinates;
}

export function getGeom(
  geojson: Feature<Geometry | GeometryCollection> | Geometry | GeometryCollection,
): Geometry | GeometryCollection {
  if (geojson.type === "Feature") return (geojson as Feature<Geometry | GeometryCollection>).geometry;

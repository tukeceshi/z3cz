...
describe("midpoint", () => {
  it("should match turf for Paris to London", () => {
    ...
    expect(ours.geometry.coordinates[0]).toBeCloseTo(turfs.geometry.coordinates[0], 6);
    expect(ours.geometry.coordinates[1]).toBeCloseTo(turfs.geometry.coordinates[1], 6);
  });

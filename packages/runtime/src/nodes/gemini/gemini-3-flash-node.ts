...
// https://ai.google.dev/pricing (Gemini 3 Flash Preview)
...
/**
 * Gemini 3 Flash node implementation using the Google GenAI SDK
 * Pro-level intelligence at Flash speed and pricing
 */
export class Gemini3FlashNode extends ExecutableNode {

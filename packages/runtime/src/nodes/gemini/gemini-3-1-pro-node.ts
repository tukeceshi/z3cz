...
// https://ai.google.dev/pricing (Gemini 3.1 Pro Preview)
...
/**
 * Gemini 3.1 Pro node implementation using the Google GenAI SDK
 * Most capable model for complex reasoning and creative tasks
 */
export class Gemini31ProNode extends ExecutableNode {

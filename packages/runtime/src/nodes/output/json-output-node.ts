...
import type { JsonObject, NodeExecution, NodeType } from "@dafthunk/types";
...
export class JsonOutputNode extends ExecutableNode {
  public static readonly nodeType: NodeType = {
    ...
    icon: "braces",
    documentation:
      "This node displays JSON data in the workflow. The value is persisted for viewing in read-only execution views.",
    inlinable: true,
    inputs: [
      {
        name: "value",

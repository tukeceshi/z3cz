...
export class Recraft20bSvgNode extends ExecutableNode {
  ...
  public static readonly nodeType: NodeType = {
    ...
    icon: "pen-tool",
    documentation:
      "This node generates scalable vector graphics (SVG) from text prompts using the Recraft 20B SVG model via Replicate. Supports vector illustrations and icons with multiple style options.",
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "string",
        description:
          "Style: vector_illustration, icon, or substyles like vector_illustration/cartoon, icon/outline",

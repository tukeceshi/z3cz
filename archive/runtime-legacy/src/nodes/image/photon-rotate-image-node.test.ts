...
import { PhotonRotateImageNode } from "./photon-rotate-image-node";

describe("PhotonRotateImageNode", () => {
  it("should process image", async () => {
    const nodeId = "photon-rotate-image";
    const node = new PhotonRotateImageNode({
      nodeId,
    } as unknown as Node);

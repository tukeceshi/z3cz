...
import { PhotonOilPaintingNode } from "./photon-oil-painting-node";

describe("PhotonOilPaintingNode", () => {
  it("should process image", async () => {
    const nodeId = "photon-oil-painting";
    const node = new PhotonOilPaintingNode({
      nodeId,
    } as unknown as Node);

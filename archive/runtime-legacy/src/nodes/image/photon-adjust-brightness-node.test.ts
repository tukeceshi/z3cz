...
import { PhotonAdjustBrightnessNode } from "./photon-adjust-brightness-node";

describe("PhotonAdjustBrightnessNode", () => {
  it("should process image", async () => {
    const nodeId = "photon-adjust-brightness";
    const node = new PhotonAdjustBrightnessNode({
      nodeId,
    } as unknown as Node);

...
import { testImageData } from "@dafthunk/runtime/test/fixtures/image-fixtures";
import { PhotonAdjustHslLightnessNode } from "./photon-adjust-hsl-lightness-node";

describe("PhotonAdjustHslLightnessNode", () => {
  it("should process image", async () => {
    const nodeId = "photon-adjust-hsl-lightness";
    const node = new PhotonAdjustHslLightnessNode({
      nodeId,
    } as unknown as Node);

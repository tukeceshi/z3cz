...
import { PhotonInvertColorsNode } from "./photon-invert-colors-node";

describe("PhotonInvertColorsNode", () => {
  it("should process image", async () => {
    const nodeId = "photon-invert-colors";
    const node = new PhotonInvertColorsNode({
      nodeId,
    } as unknown as Node);

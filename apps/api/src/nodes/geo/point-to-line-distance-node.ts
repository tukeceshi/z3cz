...
export class PointToLineDistanceNode extends ExecutableNode {
  public static readonly nodeType: NodeType = {
    ...
    description: "Calculates the distance between a given point and the nearest point on a line. Sometimes referred to as the cross track distance.",
    tags: ["Geo", "Turf", "Distance", "Point", "LineString", "Measurement"],
    icon: "ruler",
    inputs: [
      {
        name: "point",
      ...
      },
      {
        name: "method",
        type: "string",
        description: "Distance calculation method: 'geodesic' or 'planar' (default: geodesic)",
        required: false,
      },
    ],
    outputs: [
  ...
  public async execute(context: NodeContext): Promise<NodeExecution> {
    try {
      ...
      const distance = pointToLineDistance(point as any, line as any, options as any);
      ...
      return this.createErrorResult(`Error calculating point to line distance: ${error.message}`);
    }
  }
} 
export const en = {
  ...
  landing: {
    ...
    valuePaygDesc: "Estimate tokens and cost before you generate.",
    billingTitle: "Cost estimate",
    billingSubtitle: "Credit billing is complex. This shows the final cost.",
    modelLabel: "Model",
    ...
    planSupreme: "Supreme",
    planOption: "{{name}} · {{credits}} credits{{pricePart}}",
    planPricePart: "·{{price}}/mo",
    planCycleTotal: "{{price}}/{{unit}}",
    planCycleMonthly: "Monthly",
    planCycleQuarterly: "Quarterly",
    planCycleYearly: "Yearly",
    planCycleQuarterUnit: "qtr",
    planCycleYearUnit: "yr",
    planCycleRiskHint:
      "Quarterly and yearly plans carry some risk. Please consider carefully.",
    ...
    paramAdjustHint: "Click a parameter to adjust",
    ...
    referenceBadFormat: "Use mp4, webm, mov, mkv, or m4v.",
    ...
    tableLevelBillingHintLine3: "Avoid charges in the next billing cycle.",
    ...
    tableStoragePlatform: "Platform",
    tableGptSkillValue: "Available",
    ...
    featureEditTitle: "Multi-track editing",
    featureEditDesc: "Arrange clips on the canvas timeline.",
    featureGenerateTitle: "AI generation",
    featureGenerateDesc: "Create video from text or images.",
    featureLibraryTitle: "Asset library",
    featureLibraryDesc: "Reuse files already in your workspace.",
    featureExportTitle: "High-resolution export",
    featureExportDesc: "Choose the resolution that matches your billing tier.",
    featureCloudTitle: "Cloud storage",
    featureCloudDesc: "Generated files stay with your organization.",
  ...
  sidebar: {
    ...
    seedanceVideoCheck: "Seedance Video Check",
    queues: "Queues",
    datasets: "Datasets",
    databases: "Databases",
  ...
  siteSettings: {
    ...
    icpFilingNumberHelp:
      "Optional. Shown on the homepage footer and links to the MIIT filing site.",
  ...
  competitorPricing: {
    ...
    add: "Add",
    addPromoNote: "Add discount note",
    addSuccess: "Competitor added.",
    addError: "Failed to add competitor.",
    cache: "Cache platform data",
    cacheSuccess: "Homepage data cached.",
    cacheError: "Failed to cache homepage data.",
    competitorName: "Name",
    competitorNameRequired: "Enter a name.",
    showUrl: "Link",
    url: "URL",
    urlRequired: "Enter a valid URL.",
    deleteConfirm: "Delete this competitor?",
    deleteTitle: "Confirm delete",
    removePlanConfirm: "Delete this plan?",
    removePromoConfirm: "Delete this promo?",
    deleteSuccess: "Deleted.",
    deleteError: "Failed to delete competitor.",
    empty: "No competitors yet.",
    plansTitle: "Plans",
    plansDescription:
      "Add a name, credits, and monthly price. Check quarterly or yearly first if those cycles apply.",
    planName: "Name",
    addPlan: "Add plan",
    removePlan: "Remove plan",
    plansRequired: "Add at least one plan.",
    planNameRequired: "Every plan needs a name, credits, and monthly price.",
    credits: "Credits",
    priceYuan: "Monthly (¥)",
    quarterEnabled: "Quarterly",
    yearEnabled: "Yearly",
    quarterPriceYuan: "Quarterly (¥)",
    yearPriceYuan: "Yearly (¥)",
    ...
    independentReferencePrice: "Separate price with reference",
    ...
    promoNoteText: "Discount note",
    promoNoteTextRequired: "Enter a discount note.",
    promoNoteShowDates: "Show dates",
    promoNoteDatesRequired: "Enter dates.",
  },
  bootstrapAdmin: {
    title: "Bootstrap",
    description:
      "Control first-load shell acceleration, object-storage credentials, and one-click sync after each build.",
    r2Enabled: "Storage acceleration",
    r2EnabledHint:
      "Sync the shell to the selected storage and race it against this site.",
    r2Only: "Storage only",
    r2OnlyHint: "Download from storage only, without racing this site.",
    r2OnlyNeedsSync: "Sync the current build before enabling.",
    ...
    tosCredentials: "TOS credentials",
    tosRegion: "Region",
    tosAccessKeyId: "Access key ID",
    tosSecretAccessKey: "Secret access key",
    tosBucketName: "Bucket name",
    tosSignedUrlHint:
      "Downloads use temporary signed URLs. A public base URL is not required.",
    saveSuccess: "Bootstrap settings saved.",
    saveError: "Failed to save bootstrap settings.",
    testR2: "Test R2 connection",
    testTos: "Test TOS connection",
    testing: "Testing…",
  ...
  seo: {
    routes: {
      ...
      home: "{{siteName}}",
      homeDescription: "Professional video creation with transparent pricing.",
      ...
      adminPersistWorkers: "Servers - Admin - {{siteName}}",
      ...
      seedanceVideoCheck: "Seedance Video Check - Tools - {{siteName}}",
  ...
  admin: {
    ...
    systemUpdate: {
      ...
      releaseHint: "Compare the GitHub release with the running version.",
      releaseAvailable: "Running {{current}}. You can update to {{latest}}.",
      current: "Running",
      latest: "Latest release",
      informal: "Unofficial version",
      ...
      updaterConnected: "Updater connected",
      updaterDisconnected: "Updater not connected",
      checksEmpty: "Checks appear after you look for updates.",
      checkStatus: {
        passed: "Passed",
        failed: "Failed",
        pending: "Pending",
    ...
    persistWorkers: {
      ...
      redeployDescription: 'Reinstall and restart on "{{name}}".',
      redeploySuccess: "Redeployed",
      redeployFailed: "Redeploy failed",
      bootstrapSuccess: "Added",
      bootstrapFailed: "Failed to add",
      deployLogTitle: "Deploy log",
      deployLogEmpty: "No deploy output.",
      ...
      form: {
        name: "Name",
        namePlaceholder: "Acceleration server",
        host: "Host",
        sshPort: "SSH port",
  ...
  adminApiForwarding: {
    ...
    createSuccess: "Format transform template created.",
    createSuccessWithProxy: "Created. Proxy path: {{path}}",
    createSuccessWithOrgBase: "Created. Org interface base_url: {{baseUrl}}",
    browserProxyUrl: "Browser proxy URL",
    orgInterfaceBaseUrl: "Org interface base_url",
    orgInterfaceBaseUrlHelp:
      "Use this when configuring an org AI interface—not the browser proxy URL. Docker default is http://api:3102; use http://localhost:3102 when the API runs on the host.",
    createError: "Failed to create forwarding rule.",
    applyFormatTemplate: "Apply template",
    formatTemplatePlaceholder: "Select a template",
    formatTemplateRequired: "Select a template first.",
    createWizard: {
      description:
        "Configure basic info and parameter mappings in one step, then create.",
    ...
    deleteSuccess: "Forwarding rule deleted.",
    deleteError: "Failed to delete forwarding rule.",
    loadError: "Failed to load forwarding rules.",
    ...
    lockedResolution: "Lock resolution",
    lockedResolutionNone: "Follow request",
    lockedResolutionHelp:
      "When locked, size conversion always uses this tier and ignores request resolution.",
    supportsTaskCancel: "Supports task cancellation",
    enabled: "Enabled",
    disabled: "Disabled",
    columns: {
      name: "Name",
    ...
    mapping: {
      upstreamParams: "Upstream Parameters",
      upstreamParamsHelp:
      ...
      standardSchemaHelp:
        "Platform standard body fields. Select one before adding an upstream parameter.",
  ...
  pages: {
    ...
    cloudAcceleration: {
      ...
      description:
        "After you add a server, selected interfaces can use it for access and downloads.",
      ...
      interfaceListEmpty: "No interfaces yet",
      interfaceListAdd: "Add",
      interfaceListAddTitle: "Add interface",
      interfaceListAddEmpty: "No interfaces left to add",
      interfaceListRemove: "Remove",
      interfaceListAdded: "Added",
      interfaceListRemoved: "Removed",
      ...
      apiForwardingTitle: "API forwarding",
      apiForwardingHint:
        "Access the interface through a server, or directly if none is available.",
      apiForwardingEmpty: "No interfaces yet",
      apiForwardingAdd: "Add",
      apiForwardingAddTitle: "Add forwarded interface",
      apiForwardingAddEmpty: "No interfaces left to add",
      apiForwardingRemove: "Remove",
      apiForwardingAdded: "Added",
      apiForwardingRemoved: "Removed",
      apiForwardingUpdateFailed: "Update failed",
    },
    aiInterfaces: {
      ...
      singleModel: {
        ...
        useOfficialEndpointRules: "Use official rules",
        customEndpointParams:
          "Custom parameters (non-official formats require parameter mapping)",
        endpointPreviewFullUrl: "Full URL",
        endpointPreviewEmpty: "Enter an endpoint URL to preview",
        noSuffixConcatenation:
          "Do not append suffix (check the example URL in your API docs)",
        supportsTaskCancel: "Supports task cancellation",
        endpointRulesInvalid: "Invalid endpoint path configuration",
        accessKeyId: "Access Key ID",
        secretAccessKey: "Secret Access Key",
        ...
        formatTemplateRequired:
          "Format mapping is required when not using official rules.",
        formatMappingSettingsTitle: "Format mapping settings",
        capabilityLimitsSettingsTitle: "Capability limits settings",
        addModel: "Add",
        addModelPlaceholder: "Select a model to add",
        addedCount: "Added {{count}}",
        noModelsAdded: "No models added yet",
        formatTransformSettingsTitle: "Template settings",
        formatTransformNotConfigured:
        ...
        resolutionLimits: "Allowed resolutions",
        referenceLimitsTitle: "Reference counts",
        maxReferenceImages: "Reference images",
        maxReferenceVideos: "Reference videos",
        maxReferenceAudios: "Reference audio",
        platformLimitHint: "Platform max {{max}}",
        ...
        formatTemplateRulesMappings: "Parameter mappings",
        formatTemplateRulesNone: "None",
        formatTemplateRulesYes: "Yes",
        formatTemplateRulesNo: "No",
        saveHint:
      ...
      mediaKitEnhance: {
        ...
        activateLink: "Enable in Volcano Engine",
        ...
        pricingFpsHint: "Reference price per second at ≤30fps",
        pricingVersionColumn: "Version",
    ...
    adminAiModels: {
      ...
      sectionFeatures: "Generation parameters",
      ...
      maxImageReferenceBytes: "Max MB per image reference",
      maxVideoReferences: "Max video references",
      maxVideoReferenceBytes: "Max MB per video reference",
      maxVideoReferenceSeconds: "Max video duration (seconds)",
      priceEstimateLabel: "Price estimate",
      priceEstimatePricesTitle: "Unit price (CNY per million tokens)",
      priceEstimateTierEnabled: "On",
      priceEstimateResolution: "Resolution",
      ...
      groupIcon: "Logo",
      groupIconDefault: "Default",
      groupIconDoubao: "Doubao",
      createGroup: "Create group",
      createGroupTitle: "New group",
      editGroupTitle: "Edit group — {{name}}",
      showCreateGroup: "New group",
      hideCreateGroup: "Collapse",
      ...
      sizePolicyLabel: "Size",
      sizeResolutionLabel: "Resolution",
      sizeRatioLabel: "Aspect ratio",
      imageCountLabel: "Generation count",
      implementationModeLabel: "Implementation",
      sizeEffectModeRatioPrompt: "Resolution + ratio in prompt",
      sizeEffectModePixelSize: "Compute pixel dimensions",
      countEffectModeSeedreamSequential: "Seedream sequential",
      countEffectModeDirect: "Direct API parameter",
      countTotalLabel: "Total count",
      countDefaultLabel: "Default count",
      videoDurationMinLabel: "Min duration (seconds)",
      videoDurationMaxLabel: "Max duration (seconds)",
      videoDurationDefaultLabel: "Default duration (seconds)",
      videoDurationLabel: "Duration",
      videoCountLabel: "Batch count",
      videoReferenceMode: {
        referenceImage: "Omni reference",
        firstLastFrame: "First & last frame",
      },
      defaultStateLabel: "Default state",
    ...
    seedanceVideoCheck: {
      title: "Seedance Video Check",
      description:
        "Verify whether a video was generated by official Volcano Ark Seedance models.",
      enterpriseAlertTitle: "Enterprise Volcano account required",
      enterpriseAlertDescription:
        "Only enterprise Volcano Engine accounts can call the official artifact verification APIs. Personal or trial accounts cannot query results.",
      limitationsTitle: "Important notes",
      limitationsLine1:
        "“Not detected” does not prove the video was not generated by Seedance.",
      limitationsLine2:
        "Official metadata is mainly available within about 30 days after generation. Transcoding or re-encoding may affect results.",
      volcanoRequiredTitle: "Volcano Engine interface required",
      volcanoRequiredDescription:
        "Add and configure a Volcano Engine AI interface before using this tool.",
      openAiInterfaces: "Open AI interfaces",
      tabs: {
        upload: "Upload file",
        cached: "My videos",
        url: "External URL",
      ...
      uploadHint: "Supports MP4, MOV, WebM, and similar formats.",
      urlLabel: "Public video URL",
      urlHint: "Paste a direct link that Volcano Engine can fetch over HTTPS.",
      cachedEmpty: "No cached AI video resources found on this device.",
      checkAction: "Start check",
      ...
      errors: {
        urlRequired: "Enter a public video URL.",
        ...
        checkFailed: "Video check failed",
        enterpriseRequired:
          "This Volcano account cannot query official results. Upgrade to an enterprise account and try again.",
      },
    },
  ...
  workflow: {
    ...
    generativeParams: {
      ...
      fields: {
        ...
        virtual_avatar_library: "Virtual avatar library",
        seed: "Random seed",
        execution_expires_after: "Task timeout",
        speed: "Speed",
        vol: "Volume",
        pitch: "Pitch",
        emotion: "Emotion",
      ...
      options: {
        ...
        reference_mode: {
          reference_image: "Omni reference",
    ...
    canvas: {
      ...
      agentInputPlaceholder: "Ask anything, @ to mention a node",
      ...
      agentToolReadCanvas: "Read the canvas",
      agentToolResolveResource: "Resolved a resource",
      agentStatusGenerating: "Generating…",
      agentStatusReconnecting: "Reconnecting…",
      agentStatusStopped: "Stopped",
      agentResumeFailed: "Could not resume this reply",
      agentSwitchModel: "Switch model",
      agentContextUsage: "{{used}} / {{limit}}",
      agentContextLength: "Context",
      agentCacheHitRate: "Cache hit",
      ...
      agentAsk: "Ask",
      agentExecute: "Run",
      agentExecuteDone: "Ran",
      agentExecuteHint: "Confirm to change what you see",
      agentEventEndHint: "Confirm to end this and start a new chat",
      agentLeavePlan: "Leave draft",
      agentLeavePlanHint: "Leave to Ask, or make the draft real",
      agentLeaveView: "Back to Ask",
      agentLeaveReal: "Back to draft",
      agentPlanPanel: "Draft",
      agentPlanChip: "Draft",
      agentViewChip: "View",
      agentDraftChip: "Draft",
      agentRealChip: "Run",
      agentToolCall: "Tool",
      agentAskSubmit: "Continue after choosing",
      agentPlanDocument: "Draft",
      agentStatusWaitingPlan: "Waiting to confirm",
      agentStatusExecuting: "Running",
      agentSimpleAnimation: "Simple animation",
      agentSimpleAnimationExit: "Exit simple animation",
      agentToolRemotionOpen: "Opened simple animation",
      agentToolRemotionClose: "Exited simple animation",
      agentToolRemotionGet: "Read simple animation",
      agentToolRemotionWrite: "Updated simple animation",
      agentToolWriteText: "Wrote to a text node",
      agentToolCreateFlow: "Created a generation node",
      agentToolConnectNodes: "Connected nodes",
      agentToolRunNode: "Ran a node",
      agentToolStageMedia: "Staged media",
      agentRemotionPreview: "Simple animation",
      remotionViewportTitle: "Simple animation",
      remotionViewportClose: "Hide simple animation",
      remotionViewportExpandCode: "Expand code",
      remotionViewportCollapseCode: "Collapse code",
      remotionViewportLoading: "Loading preview…",
      agentHistoryEmpty: "No conversations yet",
      agentUntitled: "Untitled",
      agentInUse: "In use",
      agentInUseTitle: "Can't open",
      agentInUseOk: "OK",
      agentNoModel: "No text model available",
      agentGenerateFailed: "Generation failed",
      agentResendTitle: "Resend",
      agentResendConfirm:
        "Resending from here will delete the replies below. Continue?",
      agentResendAction: "Resend",
      fitToScreen: "Fit to Screen",
      zoomOneToOne: "Zoom 100% (1:1)",
      reorganizeLayout: "Reorganize Layout",
      delete: "Delete",
      deleteConfirmTitle: "Confirm delete",
      deleteConfirmNodes: "Delete {{count}} selected node(s)?",
      ...
      themeTipDontShow: "Don't show again",
      duplicate: "Duplicate",
      copy: "Copy",
      cut: "Cut",
      paste: "Paste",
    ...
    studio: {
      ...
      edit: "Edit",
      expand: "Expand list",
      empty: "No generative nodes yet",
      emptyMedia: "No content yet",
      ...
      listInteractionHint: {
        ...
        singleClickAction: "Single-click",
        singleClickRest: " another node: quick preview",
        dragAction: "Drag",
        dragRest: " a node into the edit pane as reference",
        dismiss: "Hide hint",
      },
      addNodeDrop: {
        hint: "or drop a file to create a node",
    ...
    aiTextPanel: {
      ...
      keywordsPending: "Upstream text node is still loading",
      ...
      modelsLoadFailed: "Couldn't load models",
    ...
    cloudAcceleration: {
      ...
      dialogDescription:
        "Servers will download and upload to cloud storage for you when the network is slow.",
    ...
    aiImagePanel: {
      ...
      persistDownloadingPercent: "Downloading {{percent}}%",
      ...
      sizeLabel2K: "HD 2K",
      sizeLabel4K: "UHD 4K",
      optimizePromptStandard: "Standard mode",
      optimizePromptFast: "Fast (lower quality)",
      watermarkHint: 'When enabled, adds "AI 生成" in the bottom-right corner',
    ...
    aiVideoPanel: {
      ...
      params: "Params",
      paramsTitle: "Generation parameters",
      priceEstimateSummary: "~{{cost}} CNY~{{megaTokens}}M",
      ...
      priceEstimateUnitRateValue: "{{rate}} CNY/s",
      priceEstimateDisclaimer: "Estimate only — no charge is applied.",
      paramToggleOn: "On",
      paramToggleOff: "Off",
    ...
    videoEnhance: {
      ...
      fps: "Frame rate",
      generate: "Generate",
      noHigherResolution: "Source video is already at the highest tier",
      notConfiguredHint:
        "Enable AI MediaKit video enhance and configure an API key in AI / Resources interfaces",
      openAiInterfaces: "Open interface settings",
      configLoadFailed: "Failed to load MediaKit configuration",
      sourceMissing: "Source video is missing",
      createNodeFailed: "Failed to create enhance node",
      referenceLinkFailed:

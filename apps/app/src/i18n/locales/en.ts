export const en = {
  ...
  workflow: {
    ...
    canvas: {
      ...
      agentExecuteHint: "Confirm to start changing the canvas",
      agentLeavePlan: "Leave plan",
      agentLeavePlanHint: "Leave to Ask, or run as Agent",
      agentPlanPanel: "Plan",
      agentPlanChip: "Plan",
      agentToolCall: "Tool",
      agentAskSubmit: "Continue after choosing",
      agentPlanDocument: "Plan",
      agentStatusWaitingPlan: "Waiting to run",

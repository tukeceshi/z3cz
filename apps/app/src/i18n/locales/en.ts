  ...
  pages: {
    ...
    aiInterfaces: {
      ...
      volcano: {
        ...
        step2Description:
          "Choose models to enable. Enable models in the Volcano console first; this platform does not create endpoints for you.",
        step3Description:
        ...
        usageBarTooltipWithExpired:
          "Used {{usedPercent}}% · Remaining {{remainPercent}}% · Expired {{expiredPercent}}%",
        ...
        packageExpired: "Expired {{expired}}",

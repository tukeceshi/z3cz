export const en = {
  ...
  landing: {
    ...
    valueCollab: "Realtime collaboration",
    valueCollabDesc: "Several people can create on the same canvas together.",
    valueCanvas: "Freeform canvas",
    valueCanvasDesc: "Drag and resize the canvas and nodes without stuttering.",
    canvasTitle: "Canvas",
  ...
  bootstrapAdmin: {
    ...
    testing: "Testing…",
    testError: "R2 connection test failed.",
    syncShell: "Sync shell to R2",
    syncing: "Syncing…",
    syncError: "Shell sync failed.",

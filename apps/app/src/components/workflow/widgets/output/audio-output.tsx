...
interface AudioOutputWidgetProps extends BaseWidgetProps {
  value: ObjectReference | undefined;
  createObjectUrl?: (objectReference: ObjectReference) => string;
}

function AudioOutputWidget({
  value,
  className,
  createObjectUrl,
}: AudioOutputWidgetProps) {
  return (
...
export const audioOutputWidget = createWidget({
  component: AudioOutputWidget,
  nodeTypes: ["output-audio"],
  inputField: "value",

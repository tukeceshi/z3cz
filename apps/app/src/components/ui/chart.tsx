// Verbatim shadcn/ui chart wrapper around recharts. The `any` payload shapes
// below are deliberate: recharts' tooltip/legend payload types are internal
// and unstable across minor versions, so typing them tightly would force
// maintenance every recharts bump. Treat this file as third-party scaffold.
import * as React from "react";
import * as RechartsPrimitive from "recharts";

import { cn } from "@/utils/utils";

// Themes the chart container can target — shadcn's canonical wrapper
// emits CSS vars under both `.theme-light` and `.theme-dark` so charts
// follow the active theme without rerenders.

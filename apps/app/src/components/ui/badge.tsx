...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:border-blue-500",
  {
    variants: {
      variant: {
        default:
        ...
        "translucent-warning":
          "border-yellow-500/50 bg-yellow-500/20 text-yellow-700 dark:border-yellow-400/50 dark:bg-yellow-400/20 dark:text-yellow-300",
      },
    },
    defaultVariants: {
      variant: "default",

    ...
    <>
      ...
      <div className="space-y-4 mb-8">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl">
          Learn how to create, test, and deploy powerful workflow automations
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none docs-content">
        ...
        <ul>
          <li>
            <strong>Best for:</strong> Interactive workflows requiring user
            input, data processing and analysis, testing and development
          </li>
          <li>
        ...
        <ul>
          <li>
            <strong>Best for:</strong> Email processing automation, support
            ticket workflows, notification systems
          </li>
          <li>
        ...
        <div className="my-8">
          ...
          <div className="text-muted-foreground mb-6">
            Start creating your first workflow with our visual editor. Explore
            the playground and experiment with different node combinations.
          </div>

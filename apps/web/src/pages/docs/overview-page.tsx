...
export function DocsOverviewPage() {
  ...
  return (
    <div className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <p>
        Build workflows using our React Flow-powered visual editor with 70+ node
        types.
      </p>
      <ul>
      ...
      <p>
        Leverage Cloudflare AI for text processing, image generation, and audio
        synthesis.
      </p>
      <ul>
      ...
      <ol>
        <li>
          <strong>Learn Workflows</strong> - Understand how to create and manage
          workflows
        </li>
        <li>
          <strong>Explore Nodes</strong> - Discover the 70+ available node types
        </li>
        <li>
          <strong>Try the Playground</strong> - Build your first workflow
        </li>
        <li>
          <strong>Deploy & Monitor</strong> - Put your workflows into production
        </li>
      </ol>

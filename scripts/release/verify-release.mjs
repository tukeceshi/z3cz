...
for (const required of ["api/dist/server.mjs", "api/dist/migrate.mjs", "api/pnpm-lock.yaml", "app/index.html", "compose.yml", "Caddyfile", "VERSION", "CHANGELOG.md", "update-policy.json"]) {
